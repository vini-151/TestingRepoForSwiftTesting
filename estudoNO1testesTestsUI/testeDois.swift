...
final class testeDois: XCTestCase {
    ...
    func testExample() throws {
        ...
        springboardApp/*@START_MENU_TOKEN@*/.icons["estudoNO1testes"]/*[[".icons.icons[\"estudoNO1testes\"]",".icons[\"estudoNO1testes\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.firstMatch.tap()
